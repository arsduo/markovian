...
# This class, given a seed word and a Markov dictionary, will attempt to construct a new text using
# the Markov associations.
module Markovian
  class Chain
    class MarkovTextBuilder
      ...
      def construct(length: 140, seed: default_seed, start_result_with_seed_word: false)
        ...
        result_with_next_word(
          previous_pair: seed,
          result: start_result_with_seed_word ? seed : "",
          length: length
        )
      end
